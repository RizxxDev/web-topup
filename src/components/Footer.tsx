        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">GamerHouse</h3>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Platform terpercaya untuk top up game, pulsa, dan voucher digital.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-gray-300">
                ...
                <span>+62 851-73231171</span>
              </li>
              <li className="flex items-center gap-3 text-gray-300">
                <Mail className="w-5 h-5 text-blue-400" />
                <span>bisniskuapk@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-gray-300">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-center md:text-left">
              © {currentYear} GamerHouse. All rights reserved.
            </p>
